...
const TransactionHistory = () => {
      ...
      "outputs": [
        {
          "components": [
            ...
            {"internalType": "enum Investment.InvestmentType", "name": "investmentType", "type": "uint8"}, // Fixed: "investmentType"
  ...
  const fetchTransactionHistory = async () => {
    ...
    try {
      ...
      setError('Failed to load transaction history. Ensure MetaMask is connected and on Sepolia Testnet.');
      setLoading(false);
    }
  };
