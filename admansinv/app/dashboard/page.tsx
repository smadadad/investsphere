...
export default function Dashboard() {
  ...
  useEffect(() => {
    const connectWallet = async () => {
      ...
      const investment = new ethers.Contract(INVESTMENT_ADDRESS, INVESTMENT_ABI, ethersProvider);
      ...
      const userTxs = txs
        ...
        .map((tx) => ({
          type: tx.investmentType === 0 ? "Money Market" : tx.investmentType === 1 ? "Equity" : "Bonds",
