...
const MagicCard = () => {
  ...
  const handleInvest = () => {
    ...
    router.push(`/payment?name=${encodeURIComponent(investmentData.name)}&minimum=${investmentData.minimum}&returns=${investmentData.returns}&maturity=${investmentData.maturity}`);
  };
  ...
  return (
    <div className='border-[1px] border-gray-200 p-4 rounded-xl w-[25vw] mb-5'>
      ...
      <div
        className='flex justify-center bg-[#1e3d34] items-center rounded-lg p-3 gap-2 text-white font-semibold mt-3 cursor-pointer'
